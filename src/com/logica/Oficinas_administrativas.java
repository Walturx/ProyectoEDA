...
public class Oficinas_administrativas {
    Nodo Cabeza;
    Nodo Cola;
    int cuenta;
    boolean vacia;
    ...
    //Constructor
    public Oficinas_administrativas() {
        Cabeza=null;
        Cola=null;
        vacia=true;
    ...
    //Metodo añadir
    public void añadir_oficina(Nodo n){
        if(n==null){
    ...
    public void imprimir_oficina(){
        //Se crea una variable temporal para recorrer la cola desde el inicio
        Nodo temp = Cola;
        
        //mientras no se llegue al final de la cola temp!= null
        while(temp!=null){
            //imprime el nombre del interesado del nodo actual seguidos de una flecha
            System.out.print("Nombre: " + temp.data.Interesado.Nombres + " <--> ");
            //avanza al siguiente nodo
            temp=temp.sig;
        }
        // Al final de la cola imprime null para indicar que termino
